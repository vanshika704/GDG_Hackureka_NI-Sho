...
const JUDGES_DATA = [
  {
    id: 1,
    name: "Vipin Mehta",
    role: "Senior Architect at HCLTech",
    image: image1,
...
const SlayerJudges: React.FC = () => {
  ...
  ${JUDGES_DATA.length === 1 
    ? "grid-cols-1 place-items-center" 
    : "grid-cols-1 md:grid-cols-2 lg:grid-cols-3 place-items-center"
  }`}
// className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12 place-items-center"
           ...
           src={judge.image}
                  ...
                  <div className="mt-5 relative">
                    ...
                    <p className="text-red-600 font-mono text-[20px] tracking-[0.3em] uppercase font-bold mb-3">
                      {judge.role}
                    </p>
